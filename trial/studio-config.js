...
define(function () {
    ...
    return {
        ...
        languages_available: {
            ...
            'Script/pre' : [" ", "bash", "shell", "cmd", "scalaw", "groovy", "javascript", "python", "cpython", "ruby", "perl"],
            'Script/task' : [" ", "bash", "shell", "cmd", "scalaw", "groovy", "javascript", "python", "cpython", "ruby", "perl"],
            'Script/post' : [" ", "bash", "shell", "cmd", "scalaw", "groovy", "javascript", "python", "cpython", "ruby", "perl"],
            'Script/flow' : [" ", "scalaw", "groovy", "javascript", "python", "cpython", "ruby"],
            'Script/clean' : [" ", "bash", "shell", "cmd", "scalaw", "groovy", "javascript", "python", "cpython", "ruby", "perl"]
        },
